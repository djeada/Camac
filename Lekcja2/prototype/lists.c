...
void* get_list(struct List* list, size_t index)
{
...
void insert_list(struct List* list, void* data, size_t index)
{
	struct Container* ptr;
	size_t i = 0;
...
void del_list(struct List* list, size_t index)
{
	struct Container* ptr;
	size_t i = 0;
...
size_t lenght_list(struct List* list)
{
	return list->num;
}
